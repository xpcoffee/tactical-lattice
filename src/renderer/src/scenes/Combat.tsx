...
import { rotateFacing, moveInDirection, strafeInDirection, getLatestState, setLatestState, setPlayerBuild, COMBAT_STATE_CHANGED } from '../game/state/combat'
...
export default function Combat({ playerBuild, onNavigate: _onNavigate }: CombatProps) {
  const phaserRef = useRef<IRefPhaserGame>(null)
  const [mode, setMode] = useState<CombatMode>('idle')

  // Store the player build so Mech.tsx (and eventually Phaser) can read it.
